...
int main()
{
    cout << "Hello world C++ string demo !" << endl;
...
/*
    ...
    cout << str8 << endl;
    str8.assign(5, ch);//用len个字符ch赋值给当前字符串
    cout << str8 << endl;
...
/*
    //8.string的子串
    string str11;
    string str10="abcdfeefdhjksfdfkdlsdklwefsdfdf";
...
/*
    ...
    //从位置0开始查找字符串“opqrstuvw”前4个字符组成的字符串在当前字符串中的位置
    cout << pos << endl;
    ...
    //从string::pos开始从后向前查找字符串s中前n个字符组成的字符串在当前串中的位置
    cout << pos << endl;

    cout<<"find_first"<<endl;
    string str13 = "aaaabbbbccccdddeeefffggghhhiiijjjkkkllmmmandjfaklsdfpopdtwptioczx";
    ...
    //从位置0开始查找当前串中第一个在字符串”efff“的前3个字符组成的数组里的字符的位置
    cout << pos << endl;

    pos = str13.find_first_not_of('b', 0);//从当前串中查找第一个不在串s中的字符出现的位置
    cout << pos << endl;
    pos = str13.find_first_not_of("abcdefghijk", 0);
    //从当前串中查找第一个不在串s中的字符出现的位置
    cout << pos << endl;

    pos = str13.find_first_not_of("abcdefghijk", 0, 3);
    //从当前串中查找第一个不在由字符串”abcdefghij”的前3个字符所组成的字符串中的字符出现的位置
    cout << pos << endl;
